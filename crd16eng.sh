...
curl -sf https://raw.githubusercontent.com/xc112lg/lg_releases/refs/heads/main/crdframework.sh
ls device/lge/msm8996-common/overlay/frameworks/base/packages/SystemUI/res/values
