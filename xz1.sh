...
# ------------------------------------------
#
# extract-files.py replaces both extract-files.sh and setup-makefiles.sh:
# ExtractUtils.run() always regenerates makefiles itself, so there's no
# separate setup-makefiles step to call anymore.
#
