...
git remote add msm8997 https://github.com/Inkypen79/android_kernel_lge_msm8996.git
git fetch msm8997

# 4. Merge lineage-24.0 from that remote into swan24
git merge -X theirs msm8997/lineage-24.0 --allow-unrelated-histories -m "Merge https://github.com/Inkypen79/android_kernel_qcom_msm8998 into swan24"
